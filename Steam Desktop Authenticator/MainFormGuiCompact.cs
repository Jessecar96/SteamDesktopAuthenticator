...
{
    public partial class MainFormGuiCompact : Form
    {
        //Settings-declare
        ...
        private void menuSteamLogin_Click(object sender, EventArgs e)
        {
        ...
        private void menuCheckForUpdates_Click(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        private async void Settings_PopupNewConf_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                lblStatus.Text = "Checking confirmations > Done";
        ...
        private void loadAccountsList()
        {
            ...
            if (manifest.Encrypted)
            {
                menuManageEncryption.Text = "Manage Encryption";
            ...
            {
                menuManageEncryption.Text = "Setup Encryption";
        ...
        private void compareVersions()
        {
            ...
            {
                lblStatus.Text = "A new version is available!"; // Show the user a new version is available if they press no
